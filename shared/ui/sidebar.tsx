...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<'main'> & { noSvhAndFlex?: boolean }>(
    ({ className, noSvhAndFlex, ...props }, ref) => {
        return (
            <main
                ref={ref}
                className={cn(
                    'relative flex flex-col bg-background',
                    !noSvhAndFlex && 'min-h-svh flex-1',
